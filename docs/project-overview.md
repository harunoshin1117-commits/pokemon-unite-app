...
- 攻撃側タブにはポケモン・レベル・持ち物・ステータス・覚える技・選んだ技・攻撃ボタンを表示する
- 攻撃側タブ内では、ステータスと攻撃ボタンを横並びで表示する
- 攻撃側タブ内では、覚える技と選んだ技を横並びで表示する
- 詳細タブにはビルド保存欄を表示する
...
15. 攻撃側タブ内のステータス／攻撃ボタン、覚える技／選んだ技の横並び配置
